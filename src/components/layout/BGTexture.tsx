...
export default function BGTexture() {
    return (
        <div className="absolute inset-0 z-[-1] bg-[#f4f2ee] h-[1024px] w-full max-h-[1024px]">
            <div
                className="absolute inset-0 mix-blend-overlay h-full"
                style={{
            ...
            <div
                className="flex justify-between flex-[1_0_0px] items-center h-full w-full"
                style={{
                    mask: "linear-gradient(0deg, rgba(0, 0, 0, 0) 0%, rgb(0, 0, 0) 100%)",
                }}
            >
                {/* Left Stripe */}
                <div
                    className="flex items-center overflow-hidden w-[35%] h-full"
                    style={{
                ...
                >
                    {Array.from({ length: 8 }).map((_, i) => (
                        <div
                            key={`left-${i}`}
                            className="max-w-[82px] min-w-[70px] h-full w-[1px] flex-[1_0_0px]"
                            style={{
                                background:
