...
export default function CTA() {
    return (
        <section className="w-full px-1 lg:px-5">
            <div className="relative overflow-hidden rounded-[28px] md:rounded-4xl">
                {/* Background */}
                ...
                <div className="container mx-auto max-w-[1200px]">
                    <div className="relative z-[2] py-16 px-6 lg:py-20 lg:px-11 xl:px-[60px] xl:py-20 flex max-xl:flex-col max-xl:gap-10 max-lg:items-center justify-between text-white">
                        ...
                        {/* Right Form */}
                        <form
                            className="contact-form max-lg:max-w-[600px] xl:max-w-[600px] w-full xl:w-[58%] bg-black/30 rounded-3xl p-8 max-md:px-6 flex flex-col gap-5 max-lg:h-full max-xl:h-[570px]">
                            <div>
                        ...
                        <div className="flex xl:hidden flex-col gap-8 max-lg:mr-auto">
                            {/* Contact Info */}
                            <div className="flex flex-col gap-1 items-star">
                                <a
                                    href="tel:12068371232"
                                ...
                                <a
                                    href="mailto:hello@perklane.io"
                                    className="text-xl lg:text-[24px] xl:text-[26px] hover:text-yellow-300 font-albert"
                                >
                                    hello@perklane.io
                                </a>
                            </div>
