...
import { Home, BarChart2, Workflow, Users } from "lucide-react";
                ...
                <div className="p-20">
                    <div className="flex flex-col gap-20">
                        ...
                        <div className="flex flex-col gap-3">
                            {/* Tabs */}
                            <div className="flex gap-2 rounded-[40px] bg-[#f0ece6] p-2">
                                {features.map((tab) => {
                                    const Icon = tab.icon;
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`relative flex w-full justify-center items-center gap-2 rounded-3xl px-4 py-3.5 text-black cursor-pointer transition 
                            ...
                            <div className="bg-white/60 flex items-center gap-10 p-2 pr-10 rounded-3xl h-full">
                                <div className="h-[389px]">
                                    <div className="relative w-full h-full rounded-2xl overflow-hidden">
                                        ...
                                        {active - 1 === 1 && <div className="flex justify-center items-center">
                                            <div
                                                className="absolute right-[32px] left-[32px] top-[52%] -translate-y-1/2 h-[311px]">
                                                ...
                                                <div
                                                    className="absolute bg-white/20 rounded-xl h-[324px] -top-[16px] left-1/2 -translate-x-1/2 aspect-[1.21/1]"></div>
                                                <div
                                                    className="absolute bg-white/20 rounded-xl h-[317px] -top-[8px] left-1/2 -translate-x-1/2 aspect-[1.34/1]"></div>
                                            </div>
                                        </div>
                                        }
                                        {active - 1 === 2 && <div
                                            className="absolute top-1/2 left-1/2 h-[297px] aspect-square -translate-x-1/2 -translate-y-1/2 flex justify-center items-center">
                                            <div
                                ...
                                {/* Content */}
                                <div className="flex flex-col items-start gap-6 w-[430px] shrink-0">
                                    <div className="inline-block text-black rounded-[62px] bg-[#fef7af] px-3 py-2 uppercase text-xs">
                                        {features[active-1].label}
                                    </div>
                                    <h3 className="text-[36px] leading-[1.3em]">
